...
public class KNNPlugin extends Plugin
    ...
    /**
     * Get KNN codec service.
     * We create {@link RemoteIndexBuilder} per-index in order to consume the {@link IndexSettings} from the {@link org.apache.lucene.codecs.KnnVectorsWriter} implementation.
     */
    @Override
